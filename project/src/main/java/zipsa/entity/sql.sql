...
order by A.REV_DT asc;


-- 오늘 이전 예약일 보는 뷰
CREATE OR REPLACE VIEW V_BEFORE_TODAY AS
SELECT * FROM V_RV_STAFF
		WHERE REV_DT < SYSDATE
order by REV_DT asc;

-- 
	INSERT INTO T_MEMBER VALUES ('test1','test1','test1','010-1234-5678',sysdate,'M');
